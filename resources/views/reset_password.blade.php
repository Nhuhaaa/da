        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 offset-lg-1">
                    <h2 class="banner-title">Update password</h2>
                    <p class="breadcrumbs"><a href="{{ route('home') }}">Trang chủ</a><span>/</span>Update password</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="authWrap authForgotPassword">
                        <h2 class="authTitle">Update password</h2>
