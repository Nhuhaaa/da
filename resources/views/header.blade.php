    ...
    <div class="widget_area">
        ...
        <div class="center_align">
            <div class="about_widget_area">
                <div class="wd_logo">
                    <a href="{{ route('home') }}"><img src="makeover/images/logo.png" alt="makeover"
                            style="width: 200px;" /></a>
                </div>
                @guest
                        ...
                        <div class="container-fluid">
                            <li class="nav-item user-info">
                                ...
                                <ul class="list-unstyled user-info-list">
                                    ...
                                    <li class="user-info-item"><a class="nav-link" href="{{ route('profile') }}">Thông tin
                                            cá nhân</a></li>
                                    <li class="user-info-item"><a class="nav-link" href="{{ route('showbill') }}">Xem đơn
                                            hàng</a></li>
                                    <li class="user-info-item"><a class="nav-link" href="{{ route('showbooking') }}">Xem
                                            phiếu đặt lịch</a></li>
