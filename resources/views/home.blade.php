        ...
        <div id="rev_slider_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
            <ul>
                <li data-index="rs-3046" data-transition="random-premium" data-slotamount="default"
                    ...
                    data-saveperformance="off" data-title="" data-param1="" data-param2="" data-param3="" data-param4=""
                    ...
                    <div class="tp-caption ws_nowrap" data-x="['left', 'left', 'center', 'center']" data-hoffset="['0']"
                        ...
                        data-fontweight="['400', '400', '400', '400']" data-lineheight="['26']"
                        data-width="['420','400','100%','100%']" data-height="['250']" data-whitesapce="['normal']"
                        data-color="['#252525']" data-type="text" data-responsive_offset="off"
                        ...
                        data-paddingright="[0,0,0,30]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[20,50,0,30]"
                        data-margintop="[130,0,0,0]" data-marginleft="[80,0,0,0]"
                        style="background-image: url('makeover/images/1.jpg'); background-size: cover; background-position: center;">
                        <p style="font-size: 15px; color: #fff; font-weight: bold; margin-bottom: 10px;">Chăm sóc
                            da với công
                            nghệ chỉ với 100k</p>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="actionBox">
                        ...
                        <a href="{{ route('package') }}" class="mo_btn"><i class="icofont-cart-alt"></i>Xem sản phẩm</a>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                <div class="sectionTitle text-center">
                    ...
                    <h2>Sản phẩm <span class="colorPrimary fontWeight400">của chúng tôi</span></h2>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row shop_sort_count_row">
                    <div class="col-md-7">
                        <p class="woocommerce-result-count" style="color: #f7a392; font-size: 34px">Tất cả sản phẩm</p>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row shop_sort_count_row">
                    <div class="col-md-7">
                        <p class="woocommerce-result-count" style="color: #f7a392; font-size: 34px">Sản phẩm bán chạy
                        </p>
                    </div>
                                ...
                                <form action="{{ route('book.appointment') }}" method="POST" class="row">
                                    ...
                                    <div class="input-field col-lg-12">
                                        <input type="text" name="date_time" class="datetime-picker"
                                            placeholder="Chọn ngày & giờ (YYYY-MM-DD HH:mm)" required />
                                    </div>
                                    <div class="input-field col-lg-12">
                                        <textarea name="message" placeholder="Lời nhắn của bạn"></textarea>
                                    </div>
                                    <div class="input-field col-lg-12">
                                        <button type="submit" class="mo_btn"><i class="icofont-calendar"></i>Đặt lịch
                                            hẹn</button>
                                    </div>
                                </form>
